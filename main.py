...
bg = tk.PhotoImage(file = "sign 2.png")
window.configure(background='white')
window.grid_rowconfigure(0, weight=1)
window.grid_columnconfigure(0, weight=1)
message = tk.Label(window, text="Sign-Language",bg="SteelBlue1", fg="black", width=50,height=3, font=('times', 30, 'bold'))
...
def collect_imgs():
    name = txt2.get()
    if len(name) == 0:
        messagebox.showerror("showerror", "name is compulsory")
    else:
        DATA_DIR = './data'
...
takeImg = tk.Button(window, text="Take Images",command=collect_imgs, fg="white", bg="DodgerBlue2",width=20, height=3, activebackground="Red",
                    font=('times', 15, ' bold '))
takeImg.place(x=950, y=230)

deletedata = tk.Button(window, text="Delete data",command=delete_dataset, fg="white", bg="DodgerBlue2",width=20, height=3, activebackground="Red",
                       font=('times', 15, ' bold '))
